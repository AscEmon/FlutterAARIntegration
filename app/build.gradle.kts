...
dependencies {
    ...
    debugImplementation("com.example.merchant_sdk:flutter_debug:1.0")
    releaseImplementation("com.example.merchant_sdk:flutter_release:1.0")
    add("profileImplementation", "com.example.merchant_sdk:flutter_profile:1.0")
}
